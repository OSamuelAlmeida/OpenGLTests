...
int main()
{
    ...
    unsigned char *data = stbi_load("assets/crate0/crate0_diffuse.png", &width, &height, &nrChannels, 0);
    ...
    data = stbi_load("assets/bravion-logo.png", &width, &height, &nrChannels, 0);
